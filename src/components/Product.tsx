  ...
  return (
    <>
      ...
      <NextSeo
        ...
        canonical={`https://myshop-hi4i8cgx7-dawid-jugowiec.vercel.app/api/products/${data?.id}`}
        openGraph={{
          url: `https://myshop-hi4i8cgx7-dawid-jugowiec.vercel.app/api/products/${data?.id}`,
          title: data.title,
